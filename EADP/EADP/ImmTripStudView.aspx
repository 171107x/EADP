<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ImmTripStudView.aspx.cs" Inherits="EADP.ImmTripStudView" %>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item"><a class="nav-link active" id="study-tab" href="StudyTripStudView.aspx">Study Trips </a></li>
              <li class="nav-item"><a class="nav-link" id="immersion-tab" href="#">Immersion Trips </a></li>                       
            </ul>
            <%--            <div class="col-sm-2">
                <div class="card">
                    <div class="card-body">
