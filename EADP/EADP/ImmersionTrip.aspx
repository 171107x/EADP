<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ImmersionTrip.aspx.cs" Inherits="EADP.ImmersionTrip" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container main">
        ...
        <br />
        <br />
        <h1>Immersion Trip</h1>
        <hr />
        <h3>Current/Future Trips</h3>
        <asp:Label ID="lblMsg" runat="server" ForeColor="Red"></asp:Label>
        <asp:GridView ID="GridViewImmTrip" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" OnSelectedIndexChanged="GridViewImmTrip_SelectedIndexChanged">
            <Columns>
...
<ItemStyle Width="10%"></ItemStyle>
        ...
        <hr />
        <h3>Trips History</h3>
        <asp:GridView ID="GridViewImmHist" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" HeaderStyle-Width="10%" ItemStyle-Width="10%"
            FooterStyle-Width="10%">
            <Columns>
                <asp:BoundField DataField="TripID" HeaderText="ProgCode" />
                <asp:BoundField DataField="StartDate" DataFormatString="{0:d}" HeaderText="Start Date" />
