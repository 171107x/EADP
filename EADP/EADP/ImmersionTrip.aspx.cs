...
namespace EADP
{
    public partial class ImmersionTrip : System.Web.UI.Page
    {
        ...
        protected void GridViewImmTrip_SelectedIndexChanged(object sender, EventArgs e)
        {
            GridViewRow row = GridViewImmTrip.SelectedRow;
