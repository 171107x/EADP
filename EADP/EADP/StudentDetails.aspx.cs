    ...
    public partial class StudentDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["studInfo"] != null)
            {
                ...
                LblCustId.Text = tdList.studentAdmin.ToString();
                LblCustname.Text = tdList.studentName.ToString();
                LblAcno.Text = tdList.gender.ToString();
                LblPrincipal.Text = tdList.diploma.ToString();
                LblMaturedDte.Text = tdList.pemGroup.ToString();
                LblMaturedAmt.Text = tdList.nationality.ToString();
